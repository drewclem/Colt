      ...
      <div className='Header row'>
        <div className='hero-wrapper'>
          <div className='container hero-copy'>
            ...
            <p className='desc'>Colt is a place where beginners looking to gain real-world experience can pair with experienced programmers to work through github issues on live projects. Gone are the days are submitting job resumes with no applicable experience under your belt!
            </p>
          ...
          <div className='row'>
            <div className='About'>
              <div className="col-sm-5 about-wrapper">
                ...
                <p>One of the definitions of colt is a 'young or inexperienced person.' Back in the day, and even still in some trades today, the only way to gain experience and graduate from being a 'colt' was to work with an already skilled tradesman. The mentor/apprentice relationship was an important </p>
                <p>One thing that has always kept me in awe of the dev community is the willingness of other developers to extend a helping hand to those truely passionate and determined to learn the craft. So I asked myself, why not build a place for those eager to learn and those willing to teach to meet?</p>
            ...
            <div className='How'>
              <div className="col-sm-6 how-wrapper pull-right">
                ...
                <p><span>1. </span>Jump over the Project Board and find a a listing that interests you.</p>
